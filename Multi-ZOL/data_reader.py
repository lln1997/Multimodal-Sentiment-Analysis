import pickle
import os
from data_preprocess import data_dir, train_file, valid_file
...
class DataReader:
  ...
  def __init__(self, num_images=1, train_shuffle=False):
    ...
    self.test_data = self._read_data(os.path.join(data_dir, test_file))
  ...
  def read_test_set(self, batch_size=1):
    return self._batch_iterator(self.test_data, batch_size, desc='Test')
